...
videoOnScroll("intro", 6000, 0, 0.3, 0, 0, 0, 80);
textFadeOutScroll("intro", "h1", 3, 1500, 0);
textFadeInScroll("intro", "h2", 6, 8000, 0);

videoOnScroll("intro5", 4000, 0, 0.3, 0, 0, 7, 80);
textFadeInScroll("intro5", "h1", 6, 200, 0);

videoOnScroll("intro4", 2000, 0, 0.3, 0, 0, 12, 80);
textFadeInScroll("intro4", "h1", 6, 4000, 0);

videoOnScroll("intro2", 2500, 0, 0.3, 0, 0, 15, 80);
textFadeInScroll("intro2", "h1", 10, 200, 0);
textZoomInScroll("intro2", "option1", 10, 1000, 0);

videoOnScroll("intro3", 4000, 0, 0.3, 0, 0, 18, 80);
